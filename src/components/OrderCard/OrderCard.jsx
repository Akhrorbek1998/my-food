...
const OrderCard = ({ id, img, count, price }) => {
  return (
    <li>
      <div className="flex gap-4 items-center">
        <div className="flex justify-between items-center">
          <div className="flex gap-[6px] items-center">
            ...
            <div>
              <h4 className="text-sm font-medium leading-[18.2px]">{title}</h4>
              <p className="text-xs font-medium">{price}</p>
            </div>
          </div>
          <div className="p-[14px] rounded-md text-base font-medium leading-[22.4px]">
            {count}
          </div>
        </div>
        <span className="text-base font-medium leading-[22.4px]">$0,00</span>
      </div>
      <div className="flex gap-4 mt-[10px]">
        <input
          className="p-[14px] rounded-md bg-[#2D303E] border border-base-dark-line"
          type="text"
          placeholder="Order Note..."
        />
        <button className="w-12 h-12 flex items-center justify-center rounded-md border border-primary">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
